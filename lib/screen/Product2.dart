...
class _Product2State extends State<Product2> {
        ...
        child:  Scaffold(
            ...
            appBar: AppBar(
              ...
              bottom: TabBar(
                  tabs: [
                    Tab(
                      child: Text("Keyboard",style: TextStyle(color: Colors.grey),) ,
                    ),

                    Tab(
                      child: Text("Mouse",style: TextStyle(color: Colors.grey),) ,
                    ),
                    Tab(
                      child: Text("Cable",style: TextStyle(color: Colors.grey),) ,
                    ),
                  ]),
  ...
  Widget listproduct(List product ){
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  Details(image: product[index]['image'],
                product: product[index]['detals'],name: product[index]['name'],price: product[index]['Price'],),
              ));

            },
            child: Card(shadowColor: Colors.red,
              ...
              child:  Center(
                child: Container(
                  ...
                  child:ListTile(
                    trailing: Text(product[index]['Price'].toString(),style: TextStyle(fontSize: 20,color: Colors.red),),
                    leading:CircleAvatar(

                      backgroundImage: NetworkImage( product[index]['image']),
                    ),


                    title: Text(product[index]['name'],style: TextStyle(fontSize: 20),),
                  ),
                ),
              ),
            ),
